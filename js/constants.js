...
export const ALUNOS_POR_TURMA = {
  "8D": ["Alice Tavares", "Alice Paz", "Ana Julia", "Arthur", "Francisco", "Isaac", "João Pedro", "Karolinny", "Ketelly", "Leticia", "Lucas Gabriel", "Lucas Matheus", "Luis Gabriel", "Luis Miguel", "Miguel Henrique", "Miguel Nascimento", "Wanderson", "Izabelly Monik", "Nixmarys", "Thalles Davi", "Pedro Riquelme", "Sandra"],
  ...
  "8G": ["Ana Clara", "Ana Gabryella", "Ana Maria", "Davi Emanoel", "Davi Francisco", "Helena", "Isabela", "Karlos", "Ketelen", "Lorran", "Maria Clara", "Maria Eduarda", "Maria Laura", "Maria Sophia", "Natalya", "Pablo", "Paulo Henrique", "Pedro Gabriel", "Pedro Vaz", "Pedro Henryque", "Pietro", "Pyetro", "Renan", "Sophia", "Thays", "Victor", "Beatriz", "Letícia", "Erik"],
...
export const NUM_CHAMADA = {
  "8D": {"Alice Tavares":1, "Alice Paz":2, "Ana Julia":3, "Arthur":4, "Francisco":6, "Isaac":7, "João Pedro":10, "Karolinny":11, "Ketelly":12, "Leticia":14, "Lucas Gabriel":16, "Lucas Matheus":17, "Luis Gabriel":18, "Luis Miguel":19, "Miguel Henrique":22, "Miguel Nascimento":23, "Wanderson":25, "Izabelly Monik":26, "Nixmarys":27, "Thalles Davi":28, "Pedro Riquelme":29, "Sandra":30},
...
// Nº de aulas que uma turma tem num dia (conta os tempos na GRADE_HORARIO).
// data = "YYYY-MM-DD". Fim de semana / turma sem aula no dia => 0.
export function aulasNoDia(turma, data){
  if(!turma || !data) return 0;
  const dow = new Date(data + "T12:00:00").getDay();  // 0=dom..6=sáb
  const grade = GRADE_HORARIO[dow];
  if(!grade) return 0;
  let n = 0;
  for(const t of Object.keys(grade)) if(grade[t] === turma) n++;
  return n;
}
