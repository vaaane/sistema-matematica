...
export const ALUNOS_POR_TURMA = {
  "8D": ["Alice Tavares", "Alice Paz", "Ana Julia", "Arthur", "Francisco", "Isaac", "João Pedro", "Karolinny", "Ketelly", "Leticia", "Lucas Gabriel", "Lucas Matheus", "Luis Gabriel", "Luis Miguel", "Miguel Henrique", "Miguel Nascimento", "Wanderson", "Izabelly Monik", "Nixmarys", "Thalles Davi"],
...
export const NUM_CHAMADA = {
  "8D": {"Alice Tavares":1, "Alice Paz":2, "Ana Julia":3, "Arthur":4, "Francisco":6, "Isaac":7, "João Pedro":10, "Karolinny":11, "Ketelly":12, "Leticia":14, "Lucas Gabriel":16, "Lucas Matheus":17, "Luis Gabriel":18, "Luis Miguel":19, "Miguel Henrique":22, "Miguel Nascimento":23, "Wanderson":25, "Izabelly Monik":26, "Nixmarys":27, "Thalles Davi":28},
