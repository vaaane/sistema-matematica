...
export function renderSidebarAluno(containerId, activePage) {
  ...
  const nav = [
    ...
    { id:"certificados", href:"/aluno/certificados.html", label:"Certificados", icon:`<path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 13l-4-4 1.41-1.41L10 11.17l6.59-6.59L18 6l-8 8z"/>` },
...
export function renderSidebarProfessor(containerId, activePage) {
  ...
  const navExtra = [
    ...
    { id:"certificados", href:"/professor/certificados.html", label:"Certificados",     icon:`<path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 13l-4-4 1.41-1.41L10 11.17l6.59-6.59L18 6l-8 8z"/>` },
  ...
  const navJogos = [
    ...
    { id:"runner_jogo",     href:"/professor/runner.html",            label:"Runner · Jogar",      icon:`<path d="M13.49 5.48c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm-3.6 13.9l1-4.4 2.1 2v6h2v-7.5l-2.1-2 .6-3c1.3 1.5 3.3 2.5 5.5 2.5v-2c-1.9 0-3.5-1-4.3-2.4l-1-1.6c-.4-.6-1-1-1.7-1-.3 0-.5.1-.8.1l-5.2 2.2v4.7h2v-3.4l1.8-.7-1.6 8.1-4.9-1-.4 2 7 1.4z"/>` },
    { id:"runner_analise",  href:"/professor/runner_analise.html",    label:"Runner · Análise",    icon:`<path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/>` },
  ];
