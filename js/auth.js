...
export function renderSidebarProfessor(containerId, activePage) {
  const nav = [
    ...
    { id:"acomp_aluno",    href:"/professor/acompanhamento_aluno.html", label:"Ficha do Aluno", icon:`<path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4zm7-9V2h-2v3h-3v2h3v3h2V7h3V5h-3z"/>` },
  ...
  const navExtra = [
    ...
    { id:"provas",       href:"/professor/p-provas.html",     label:"Provas e Testes",   icon:`<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/>` },
